...
unsigned NVRAM_read_address;		//NVRAM����ַ
unsigned char NVRAM_read_data;		//NVRAM������
unsigned NVRAM_write_address;		//NVRAMд��ַ
unsigned char NVRAM_write_data;		//NVRAMд����
...
unsigned data_reference_line = 0;   //���籣���ù�·�ο�
//
//void EE_events()        //
//{
//    while(T1_EE >= 100)         //�ڷ���״̬ÿ1�뱣��һ��״̬
//    {    
//        T1_EE = 0;
////        writeSEE(EE_system_state,system_state);         
//
//    }
//}
//
